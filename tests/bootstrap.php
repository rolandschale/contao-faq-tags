...
$fixtureLoader = function ($class): void {
    ...
    if (false !== strpos($class, '\\') && 0 !== strncmp($class, 'Contao\\', 7) && 0 !== strncmp($class, 'Codefog\FaqTagsBundle\\', 19)) {
        return;
    }
    ...
    if (0 === strncmp($class, 'Codefog\FaqTagsBundle\\', 19)) {
    ...
    if (file_exists(__DIR__.'/Fixtures/'.$file.'.php')) {
        ...
        if ($isContaoClass) {
            class_alias('Codefog\FaqTagsBundle\Test\Fixtures\\'.$class, 'Contao\\'.$class);
        } elseif ($isBundleClass) {
            class_alias('Codefog\FaqTagsBundle\Test\Fixtures\\'.$class, 'Codefog\FaqTagsBundle\\'.$class);
        }
    }
